...
public class DaySummaryDo {
    ...
    public DaySummaryDo(Integer id, String day_summary_code, String day_summary_time, String day_summary_content, String day_summary_entry_time, String day_summary_reply, String day_summary_see, Integer day_summary_state, Integer peo_id) {
        this.id = id;
