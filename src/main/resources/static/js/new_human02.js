        ...
        success: function (res) {
            ...
            $.each(res.weekPlanExtendDOS, function (index, obj) {
                $("#table_id").append("<tr onmodify='false' id='trOne'>"+
                    ...
                    "<td><a href='#' id='"+obj["weekPlanId"]+"\' class='month_a'>查看</a></td>" +
        ...
        $.ajax({
            ...
            success:function (res) {
                if (res.code==null){
                    ...
                    // alert(trSeq)
                    oneP_plan_week.value = res.weekPlanExtendDO.week_plan_content;
                    oneP_end_week.value = res.weekPlanExtendDO.week_plan_entry_time;
                    oneP_plan.value=res.weekPlanExtendDO.monthlyPlan.monthly_plan_content;
                    oneP_end.value=res.weekPlanExtendDO.monthlyPlan.monthly_plan_entry_time;
                }
